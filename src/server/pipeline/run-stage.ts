...
import { buildStagePrompt, buildSystemPrompt, type StagePromptInput } from "./prompt";
...
export async function runStage(options: RunStageOptions): Promise<StageExecutionResult> {
