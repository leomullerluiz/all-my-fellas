// Generated via `npx shadcn@latest add calendar` and adapted to this repo's
// `Button` (only `primary|secondary|ghost|danger|success` variants and
// `sm|md|lg|icon` sizes exist here — upstream's `outline` variant maps to
// `secondary`) and quote/semicolon style.
"use client";
    ...
    <Button
      ...
      className={cn(
        "flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 font-normal " +
          "leading-none group-data-[focused=true]/day:relative " +
